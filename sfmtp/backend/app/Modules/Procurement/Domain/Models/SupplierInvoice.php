...
/**
 * A supplier's invoice, matched to what was received on a purchase order. Paid in Phase 8.
 */
class SupplierInvoice extends Model
{
    ...
    {
        return ['invoice_date' => 'date', 'due_on' => 'date', 'amount' => 'decimal:2', 'version' => 'integer'];
    }
